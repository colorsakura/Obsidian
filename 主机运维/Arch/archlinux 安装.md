...
> 经过了上一节的准备工作，我们可以开始正式安装 archlinux 了。如果你还没有完成前面的阅读，请先仔细阅读章节 [安装前的准备](https://arch.icekylin.online/rookie/pre-install.html)。如果对本节的步骤不理解或者有疑问，请阅读下一节 [基础安装详解](https://arch.icekylin.online/basic-install-detail.html)
...
## [#](https://arch.icekylin.online/rookie/basic-install.html#_0-进入安装环境) 0. 进入安装环境

![archlinux-iso-1](https://arch.icekylin.online/assets/img/pre-virt_vb-17.fd60d8a2.png)

1.  在第一个选项回车

![archlinux-iso-2](https://arch.icekylin.online/assets/img/pre-virt_vb-18.76cb559e.png)
...
![stop-reflector](https://arch.icekylin.online/assets/img/basic-install_reflector.fe556737.png)
...
![check-efi](https://arch.icekylin.online/assets/img/basic-install_check-efi.9886395f.png)
...
### [#](https://arch.icekylin.online/rookie/basic-install.html#若使用无线连接) 若使用**无线连接**：
...
### [#](https://arch.icekylin.online/rookie/basic-install.html#若使用有线连接) 若使用**有线连接**：
...
## [#](https://arch.icekylin.online/rookie/basic-install.html#_4-测试网络连通性) 4. 测试网络连通性
...
![ping](https://arch.icekylin.online/assets/img/basic-install_ping.c00c9114.png)
...
[](https://wiki.archlinux.org/title/Network_configuration_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)/Wireless_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)#%E6%A3%80%E6%9F%A5%E8%AE%BE%E5%A4%87%E7%8A%B6%E6%80%81)

[](https://wiki.archlinux.org/title/Network_configuration_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)/Wireless_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)#%E6%A3%80%E6%9F%A5%E8%AE%BE%E5%A4%87%E7%8A%B6%E6%80%81)。

## [#](https://arch.icekylin.online/rookie/basic-install.html#_5-更新系统时钟) 5. 更新系统时钟
...
![time](https://arch.icekylin.online/assets/img/basic-install_time.1d58b92c.png)

## [#](https://arch.icekylin.online/rookie/basic-install.html#_6-更换国内软件仓库镜像源加快下载速度) 6. 更换国内软件仓库镜像源加快下载速度
...
![mirrorlist-1](https://arch.icekylin.online/assets/img/basic-install_mirrorlist-1.7ba95e2a.png)
...
![mirrorlist-2](https://arch.icekylin.online/assets/img/basic-install_mirrorlist-2.a1e7a5dd.png)
...
![partition-1](https://arch.icekylin.online/assets/img/basic-install_partition-1.ba27f5df.png)
...
![partition-3](https://arch.icekylin.online/assets/img/basic-install_partition-3.13f32a01.png)

4.  按下回车后会提示输入 `分区大小`，Swap 分区建议为**电脑内存大小的 60%**，或者和内存大小相等 > 然后按下回车 `Enter`

![partition-4](https://arch.icekylin.online/assets/img/basic-install_partition-4.7780dc58.png)
...
![mount_step-1](https://arch.icekylin.online/assets/img/basic-install_mount-1.c8c7d331.png)

![mount_step-2](https://arch.icekylin.online/assets/img/basic-install_mount-2.71b6ce46.png)
